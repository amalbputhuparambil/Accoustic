...
import com.brocamp.AcousticAlchemy.exception.OrderDetailsNotFoundException;
import com.brocamp.AcousticAlchemy.model.*;
import com.brocamp.AcousticAlchemy.repository.*;
...
public class OrderDetailsServiceImpl implements OrderDetailsService {
    ...
    @Override
    public void returnCustomerOrder(long id) {
        Optional<OrderDetails> orderDetails=orderDetailsRepository.findById(id);
        OrderDetails orderDetails1=orderDetails.get();
        orderDetails1.setReturned(1);
        orderDetails1.setOrderStatus("RETURN REQUESTED");
        orderDetailsRepository.save(orderDetails1);

    }

    @Override
    public void returnResponse(long id,long userId) {
        Optional<OrderDetails> orderDetails=orderDetailsRepository.findById(id);
        OrderDetails orderDetails1=orderDetails.get();
        orderDetails1.setOrderStatus("RETURNED SUCCESSFULLY");
        orderDetails1.setReturned(2);
        orderDetailsRepository.save(orderDetails1);
