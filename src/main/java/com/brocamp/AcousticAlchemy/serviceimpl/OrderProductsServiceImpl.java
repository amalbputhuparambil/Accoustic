...
import com.brocamp.AcousticAlchemy.exception.OrderProductsNotFoundException;
import com.brocamp.AcousticAlchemy.exception.ProductNotFoundException;
import com.brocamp.AcousticAlchemy.model.OrderProducts;
import com.brocamp.AcousticAlchemy.model.Product;
import com.brocamp.AcousticAlchemy.repository.OrderProductsRepository;
import com.brocamp.AcousticAlchemy.repository.ProductRepository;
...
public class OrderProductsServiceImpl implements OrderProductsService {
    ...
    public List<OrderProductsDTO> getAllProductSalesByDate(String status, Date date) {
        ...
        System.out.println("hiiiiiiiiiii"+orderProductsObj);
    ...
    @Override
    public OrderProducts findByOrderProductId(long id) {
        OrderProducts orderProducts=orderProductsRepository.findByOrderProductId(id);
